    ...
    <div className="flex gap-x-4 pr-3">
      <div className="grow">
        <div className="flex">
          ...
          <div className="flex input-wrapper max-w-12 ml-auto max-h-10 rounded-lg bg-[#2d303e] text-[#889898]">
            <button
              className="text-xl hover:text-green-700 hover:bg-green-400 rounded-l-lg"
              onClick={() => {
            ...
            <input
              className="w-[100%] h-[100%] bg-[#2d303e] rounded text-center"
              type="text"
              value={count}
            />
            <button
              className="text-3xl hover:text-red-700 hover:bg-[#ea7c69] rounded-r-lg"
              onClick={() => {
